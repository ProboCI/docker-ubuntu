...
echo "Backing up 20.04-php8.3"
docker save proboci/ubuntu:20.04-php8.3 > image-backups/20.04-php8.3-$(date +%Y-%m-%d).tar
gzip image-backups/20.04-php8.3-$(date +%Y-%m-%d).tar
